...
df = pd.read_csv("./Step_1_MM20230116_plate006_long.csv")
...
df.head()
#df.to_csv("MM20230116_ROS6_intertimpoint_foldchange.csv")
print(df)
...
ctrl_group = ctrl_df.groupby(["assay_id", "timepoint"], as_index=False, group_keys=False)\
    .agg(
        inter_timepoint_fold_change_ctrl=("inter_timepoint_fold_change", "median"),
    )
...
auc_df.to_csv("MM20230116_2_auc_data.csv")
auc_df
